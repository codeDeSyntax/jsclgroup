        ...
        >
          ...
          <div className="mt-4 sm:mt-5 lg:mt-6">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm font-semibold transition bg-black text-white hover:bg-black/85"
            >
              {slide.cta}
