...
export const adminSelectClass =
  "flex h-11 w-full appearance-none rounded-xl border border-transparent bg-black/[0.04] px-4 text-sm text-jcl-black shadow-sm transition hover:bg-black/[0.06] focus:border-jcl-black focus:outline-none focus:ring-2 focus:ring-jcl-black";

export const adminTextareaClass =
  "min-h-[120px] w-full resize-y rounded-xl border border-transparent bg-black/[0.04] px-4 py-3 text-sm text-jcl-black shadow-sm transition placeholder:text-black/40 hover:bg-black/[0.06] focus:border-jcl-black focus:outline-none focus:ring-2 focus:ring-jcl-black";

export const adminSectionClass =
  "overflow-hidden rounded-2xl border border-black/[0.06] bg-white shadow-[0_8px_30px_rgba(0,0,0,0.04)] sm:rounded-3xl";
